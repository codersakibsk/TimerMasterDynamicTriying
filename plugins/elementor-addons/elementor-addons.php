 ...
 * Description: This elementor addons for our responsive WordPress theme.
 * Plugin URI: https://themeix.com/plugins/elementor-addons/
 * Version: 1.0.0
 * Author: FreelancingCare
 * Author URI: https://freelancingcare.com/
...
/**
 * Elementor Addon Class
 *
 * The init class that runs elementor addons.
 ...
 * @since 1.2.0
 */
final class ElementorAddonsPlugin {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Elementor Addons', 'elementor-addons' ) . '</strong>',
