...
class Social_Rocket_Admin {
	...
	public function enqueue_styles() {
		...
		if ( ! $SR->settings['disable_fontawesome'] ) {
			wp_enqueue_style( 'fontawesome_core', plugin_dir_url( dirname( dirname( __FILE__ ) ) ) . 'css/fontawesome.min.css', array(), SOCIAL_ROCKET_VERSION, 'all' );
			wp_enqueue_style( 'fontawesome_brands', plugin_dir_url( dirname( dirname( __FILE__ ) ) ) . 'css/fa-brands.min.css', array( 'fontawesome_core' ), SOCIAL_ROCKET_VERSION, 'all' );
			wp_enqueue_style( 'fontawesome_solid', plugin_dir_url( dirname( dirname( __FILE__ ) ) ) . 'css/fa-solid.min.css', array( 'fontawesome_core' ), SOCIAL_ROCKET_VERSION, 'all' );
		}
